    ...
    >
      ...
      <style jsx>{`
        ...
        a.last span.icon {
          ...
          mask-image: url("${publicRuntimeConfig.assetPrefix}${publicRuntimeConfig.basePath}/images/icons/arrow-left.svg");
        }
        a.last {
          flex-direction: row-reverse;
        }
        a.last span.icon {
          mask-image: url("${publicRuntimeConfig.assetPrefix}${publicRuntimeConfig.basePath}/images/icons/arrow-right.svg");
        }
      `}</style>
    </a>
  </Link>
